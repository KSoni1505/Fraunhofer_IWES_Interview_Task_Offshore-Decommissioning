...
import numpy as np
from Variable_Parameter import CONSUMING_FUEL, Travelling_Time, CO2_FACTORS, FUEL_DENSITIES, CONSUMING_FUEL_3, Travelling_Time_3, CONSUMING_FUEL_2, Working_time_per_day, Decomissioning_wind_turbine_days, No_of_Wind_turbine

"Case 1: Co2 Emission from port to site"


# Extract required constants
survey_vessel_fuel_consumption = CONSUMING_FUEL["Survey_Vessel"]
SPIVs_Vessel_fuel_consumption = CONSUMING_FUEL["SPIVs_Vessel"]
Dive_Support_Vessel_fuel_consumption = CONSUMING_FUEL["Dive_Support_Vessel"]
Crew_boat_Vessel_fuel_consumption = CONSUMING_FUEL["Crew_boat_Vessel"]
Work_boat_Vessel_fuel_consumption = CONSUMING_FUEL["Work_boat_Vessel"]
Multicats_Vessel_fuel_consumption = CONSUMING_FUEL["Multicats_Vessel"]
Cargo_Vessel_fuel_consumption = CONSUMING_FUEL["Cargo_Vessel"]
Tugs_Vessel_fuel_consumption = CONSUMING_FUEL["Tugs_Vessel"]
...
co2_emission_survey_vessel = (
    (survey_vessel_fuel_consumption * Travelling_Time) * methanol_density * methanol_co2_factor) / 1000

co2_emission_SPIVs_vessel = (
    (SPIVs_Vessel_fuel_consumption * Travelling_Time) * methanol_density * methanol_co2_factor) / 1000

co2_emission_Dive_vessel = (
    (Dive_Support_Vessel_fuel_consumption * Travelling_Time) * ammonia_density * ammonia_co2_factor) / 1000

co2_emission_Crew_boat_vessel = (
    (Crew_boat_Vessel_fuel_consumption * Travelling_Time) * methanol_density * methanol_co2_factor) / 1000

co2_emission_work_boat_vessel = (
    (Work_boat_Vessel_fuel_consumption * Travelling_Time) * methanol_density * methanol_co2_factor) / 1000

co2_emission_multicats_vessel = (
    (Multicats_Vessel_fuel_consumption * Travelling_Time) * ammonia_density * ammonia_co2_factor) / 1000

co2_emission_tugs_vessel = (
    (Tugs_Vessel_fuel_consumption * Travelling_Time) * ammonia_density * ammonia_co2_factor) / 1000

co2_emission_cargo_vessel = (
    (Cargo_Vessel_fuel_consumption * Travelling_Time) * ammonia_density * ammonia_co2_factor) / 1000
...
# Extract required constants
survey_vessel_fuel_consumption_3 = CONSUMING_FUEL_3["Survey_Vessel"]
SPIVs_Vessel_fuel_consumption_3 = CONSUMING_FUEL_3["SPIVs_Vessel"]
Dive_Support_Vessel_fuel_consumption_3 = CONSUMING_FUEL_3["Dive_Support_Vessel"]
Crew_boat_Vessel_fuel_consumption_3 = CONSUMING_FUEL_3["Crew_boat_Vessel"]
Work_boat_Vessel_fuel_consumption_3 = CONSUMING_FUEL_3["Work_boat_Vessel"]
Multicats_Vessel_fuel_consumption_3 = CONSUMING_FUEL_3["Multicats_Vessel"]
Cargo_Vessel_fuel_consumption_3 = CONSUMING_FUEL_3["Cargo_Vessel"]
Tugs_Vessel_fuel_consumption_3 = CONSUMING_FUEL_3["Tugs_Vessel"]


# Calculate CO2 emission
co2_emission_survey_vessel_3 = (
    (survey_vessel_fuel_consumption_3 * Travelling_Time_3) * methanol_density * methanol_co2_factor) / 1000

co2_emission_SPIVs_vessel_3 = (
    (SPIVs_Vessel_fuel_consumption_3 * Travelling_Time_3) * methanol_density * methanol_co2_factor) / 1000

co2_emission_Dive_vessel_3 = (
    (Dive_Support_Vessel_fuel_consumption_3 * Travelling_Time_3) * ammonia_density * ammonia_co2_factor) / 1000

co2_emission_Crew_boat_vessel_3 = (
    (Crew_boat_Vessel_fuel_consumption_3 * Travelling_Time_3) * methanol_density * methanol_co2_factor) / 1000

co2_emission_work_boat_vessel_3 = (
    (Work_boat_Vessel_fuel_consumption_3 * Travelling_Time_3) * methanol_density * methanol_co2_factor) / 1000

co2_emission_multicats_vessel_3 = (
    (Multicats_Vessel_fuel_consumption_3 * Travelling_Time_3) * ammonia_density * ammonia_co2_factor) / 1000

co2_emission_tugs_vessel_3 = (
    (Tugs_Vessel_fuel_consumption_3 * Travelling_Time_3) * ammonia_density * ammonia_co2_factor) / 1000

co2_emission_cargo_vessel_3 = (
    (Cargo_Vessel_fuel_consumption_3 * Travelling_Time_3) * ammonia_density * ammonia_co2_factor) / 1000
...
# Extract required constants
survey_vessel_fuel_consumption_2 = CONSUMING_FUEL_2["Survey_Vessel"]
SPIVs_Vessel_fuel_consumption_2 = CONSUMING_FUEL_2["SPIVs_Vessel"]
Dive_Support_Vessel_fuel_consumption_2 = CONSUMING_FUEL_2["Dive_Support_Vessel"]
Crew_boat_Vessel_fuel_consumption_2 = CONSUMING_FUEL_2["Crew_boat_Vessel"]
Work_boat_Vessel_fuel_consumption_2 = CONSUMING_FUEL_2["Work_boat_Vessel"]
Multicats_Vessel_fuel_consumption_2 = CONSUMING_FUEL_2["Multicats_Vessel"]
Cargo_Vessel_fuel_consumption_2 = CONSUMING_FUEL_2["Cargo_Vessel"]
Tugs_Vessel_fuel_consumption_2 = CONSUMING_FUEL_2["Tugs_Vessel"]
...
# Calculate CO2 emission
co2_emission_survey_vessel_2 = (survey_vessel_fuel_consumption_2 * methanol_density * survey_vessel_working_time_2 *
                                Decomissioning_wind_turbine_days * No_of_Wind_turbine*methanol_co2_factor) / 1000

co2_emission_SPIVs_vessel_2 = (SPIVs_Vessel_fuel_consumption_2 * methanol_density * SPIVs_Vessel_working_time_2 *
                               Decomissioning_wind_turbine_days * No_of_Wind_turbine*methanol_co2_factor) / 1000
co2_emission_Dive_vessel_2 = (Dive_Support_Vessel_fuel_consumption_2 * ammonia_density * Dive_Support_Vessel_working_time_2 *
                              Decomissioning_wind_turbine_days * No_of_Wind_turbine*ammonia_co2_factor) / 1000

co2_emission_Crew_boat_vessel_2 = (Crew_boat_Vessel_fuel_consumption_2 * methanol_density * Dive_Support_Vessel_working_time_2 *
                                   Decomissioning_wind_turbine_days * No_of_Wind_turbine*methanol_co2_factor) / 1000

co2_emission_work_boat_vessel_2 = (Work_boat_Vessel_fuel_consumption_2 * methanol_density * Work_boat_Vessel_working_time_2 *
                                   Decomissioning_wind_turbine_days * No_of_Wind_turbine*methanol_co2_factor) / 1000

co2_emission_multicats_vessel_2 = (Multicats_Vessel_fuel_consumption_2 * ammonia_density * Multicats_Vessel_working_time_2 *
                                   Decomissioning_wind_turbine_days * No_of_Wind_turbine*ammonia_co2_factor) / 1000

co2_emission_tugs_vessel_2 = (Tugs_Vessel_fuel_consumption_2 * ammonia_density * Tugs_Vessel_working_time_2 *
                              Decomissioning_wind_turbine_days * No_of_Wind_turbine*ammonia_co2_factor) / 1000

co2_emission_cargo_vessel_2 = (Cargo_Vessel_fuel_consumption_2 * ammonia_density * Cargo_Vessel_working_time_2 *
                               Decomissioning_wind_turbine_days * No_of_Wind_turbine*ammonia_co2_factor) / 1000
